...
internal class SharedUtil: NSObject {
    ...
    static func setArrayDictionary(_ value:[Dictionary<String,Any>],_ key:String){
        userDefaultValue.set(value, forKey: key)
        userDefaultValue.synchronize()
    }

    static func getArrayDictionary(_ key:String) -> [Dictionary<String,Any>]{
        let arrayString:[Dictionary<String,Any>] = []
        if userDefaultValue.object(forKey: key) != nil{
            return userDefaultValue.array(forKey: key) as! [Dictionary<String,Any>]
        }
        return arrayString
    }
